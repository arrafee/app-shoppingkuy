...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
	...
	<h3><br> ShoppingKuy sebuah toko fashion yang bertujuan untuk memudahkan masyarakat dalam mencari outfit yang kekinian 
	<ul align="center">
        <br>
        <button type="button" class="btn btn-default btn-lg active">
        <a href="visi.php">VISI</a>
        </button>
        <button type="button" class="btn btn-default btn-lg active">
	...
	<div class="register">
        <div class="container">
            ...
            <button type="button" class="btn btn-warning btn-lg active">
                <a href="home.php"><<<</buttonKembali</a>
            </div>
        </div>
</body>
</html>